...
<div class="container-fluid justify-content-center" id="divlogin">
        ...
        <div class="card bg-dark text-white" style="border-radius: 2rem;">
          <div class="card-body p-3 text-center">
            ...
            <form id="formlogin" method="POST" novalidate>
              ...
              <p class="text-white-50 mb-5">¡Introduce tus credenciales de superheroe!</p>
              ...
              <div class="form-outline form-white mb-4" id="ti">
                ...
                <label class="form-label" for="usuario">Nick de usuario</label>
              </div>
...
if(isset($_SESSION["errorLogado"])){
  echo "<script> 
  document.getElementById('divlogin').style.display='block !important';
