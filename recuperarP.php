...
<div class="container d-flex flex-column" style="margin-top:3vw;">
 ...
 <!-- Footer -->
<footer class="text-center text-lg-start bg-white text-muted" style="margin-top:6vw;">
  <!-- Section: Social media -->
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom border-top">
    <!-- Left -->
    <div class="me-5 d-none d-lg-block">
      <span>Mantente informado siguiendonos en nuestras redes sociales:</span>
    </div>
    <!-- Left -->
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <i class='fas fa-tshirt me-3 text-secondary'></i> Frikisetas
          </h6>
          <p>
            Posible texto?¿?¿??¿
          </p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3 text-secondary"></i> Direccion?</p>
          <p>
            <i class="fas fa-envelope me-3 text-secondary"></i>
            frikisetas@gmail.com
          </p>
          <p><i class="fas fa-phone me-3 text-secondary"></i> Telefono?</p>
          <p><i class="fas fa-print me-3 text-secondary"></i> Que es este icono wtf</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
    © 2023 Copyright:
    <a class="text-reset fw-bold" href="#">HumanifyWebDesign</a>
  </div>
  <!-- Copyright -->
</footer>
